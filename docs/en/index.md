...
You can purchase SH-RPi boards from [Hat Labs Oy](https://shop.hatlabs.fi/products/sh-rpi). All design files are also available at the [SH-RPi hardware GitHub repository](https://github.com/hatlabs/sh-rpi-hardware/).
