...
<figcaption>Wiring for the NMEA 2000 interface. The red wire is left unconnected.</figcaption>
</figure>
...
<figcaption>Wiring configuration for powering the SH-RPi using the NMEA 2000 interface.</figcaption>
</figure>
